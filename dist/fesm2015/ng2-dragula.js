import { Injectable, Optional, EventEmitter, Directive, ElementRef, Input, Output, NgModule } from '@angular/core';
...
const ɵ0$1 = k => EventTypes[k];
const AllEvents = Object.keys(EventTypes).map(ɵ0$1);
