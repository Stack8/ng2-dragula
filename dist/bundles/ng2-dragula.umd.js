(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ng2-dragula'] = {}, global.ng.core, global.rxjs, global.rxjs.operators, global.dragula));
}(this, (function (exports, core, rxjs, operators, dragulaExpt) { 'use strict';
    ...
    var dragulaExpt__namespace = /*#__PURE__*/_interopNamespace(dragulaExpt);
    ...
    ***************************************************************************** */
    ...
    var ɵ0$1 = function (k) { return exports.EventTypes[k]; };
    var AllEvents = Object.keys(exports.EventTypes).map(ɵ0$1);

    var dragula = dragulaExpt__namespace.default || dragulaExpt__namespace;
    ...
    var DragulaService = /** @class */ (function () {
        function DragulaService(drakeFactory) {
            ...
            this.elContainerSource = function (eventType) { return function (groupName) { return _this.dispatch$.pipe(filterEvent(eventType, groupName, elContainerSourceProjector)); }; };
